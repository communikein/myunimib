...
public class AvailableExamAdapter extends RecyclerView.Adapter<AvailableExamAdapter.ExamAdapterViewHolder> {
    ...
    public void onBindViewHolder(ExamAdapterViewHolder examAdapterViewHolder, int position) {
        ...
        String name = mCursor.getString(ExamsFragment.INDEX_EXAM_COURSE_NAME);
        String description = mCursor.getString(ExamsFragment.INDEX_EXAM_DESCRIPTION);
        long date = (long) mCursor.getInt(ExamsFragment.INDEX_EXAM_DATE);
