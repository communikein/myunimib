...
public class AvailableExamAdapter extends RecyclerView.Adapter<AvailableExamAdapter.ExamAdapterViewHolder> {
    ...
    public void onBindViewHolder(ExamAdapterViewHolder examAdapterViewHolder, int position) {
        ...
        String name = mCursor.getString(AvailableExamsFragment.INDEX_EXAM_COURSE_NAME);
        String description = mCursor.getString(AvailableExamsFragment.INDEX_EXAM_DESCRIPTION);
        long date = (long) mCursor.getInt(AvailableExamsFragment.INDEX_EXAM_DATE);
