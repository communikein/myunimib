package it.communikein.myunimib.sync.availableexams;
...
public class SyncUtilsAvailable {
    ...
    synchronized private static void scheduleAvailableExamsSync(Context context) {
    ...
    synchronized public static void initialize(@NonNull final Context context) {
         ...
         * periodically.
         */
        scheduleAvailableExamsSync(context);
