...
import it.communikein.myunimib.databinding.ListItemBookletBinding;
import it.communikein.myunimib.ui.exam.booklet.BookletAdapter.BookletAdapterViewHolder;
...
public class BookletAdapter extends RecyclerView.Adapter<BookletAdapterViewHolder> {
     ...
     */
    public BookletAdapter(@Nullable ExamClickCallback examClickCallback) {
    ...
    public BookletAdapterViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ListItemBookletBinding binding = DataBindingUtil
                .inflate(LayoutInflater.from(parent.getContext()), R.layout.list_item_booklet,
                        parent, false);
    ...
    class BookletAdapterViewHolder extends RecyclerView.ViewHolder {
        ...
        final ListItemBookletBinding mBinding;

        BookletAdapterViewHolder(ListItemBookletBinding binding) {
