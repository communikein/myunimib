...
public class AvailableExamAdapter extends RecyclerView.Adapter<AvailableExamAdapter.ExamAdapterViewHolder> {
    ...
    private ArrayList<ListAvailableExam> mData;
    ...
    public void onBindViewHolder(ExamAdapterViewHolder examAdapterViewHolder, int position) {
        ListAvailableExam exam = mData.get(position);
     ...
     */
    void swapData(final List<ListAvailableExam> exams) {
        if (mData == null) {
            mData = (ArrayList<ListAvailableExam>) exams;
            ...
            DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                ...
                public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
                    ListAvailableExam newEntry = exams.get(newItemPosition);
                    ListAvailableExam oldEntry = exams.get(oldItemPosition);

                    return newEntry.getDescription().equals(oldEntry.getDescription()) &&
